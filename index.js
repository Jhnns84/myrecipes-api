...
let allowedOrigins = ['http://localhost:8080', 'http://localhost:1234', 'https://jhnns84.github.io/myrecipes-app/', 'https://jm-myrecipes-api.herokuapp.com/', 'https://myrecipes-app-jhnns84.netlify.app/'];
app.use(cors({
